  ...
  // =====================================================================================
	...
	public static void main(String[] args) {
		try {
			...
			/**
			List<AbstractRecommender> l =r101.loadRecommenders();
			
			AbstractRecommender r = l.get(0);
			
			r.setDataModel(r101.getDataModel());
			
			List<Integer> l2 = l.get(0).recommendItems(50);
